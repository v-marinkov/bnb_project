...
\item \textcolor{red}{\textit{OK. I'm fine with this now. You can delete this question in the next version.}}
\end{itemize}
...
\item \textcolor{red}{\textit{OK. We'll have to see if it creates any complications as far as the existence of a steady state is concerned. You can delete this question in the next version.}}
\end{itemize}
\end{enumerate}
